    ...
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-8">
            ...
            <a href="#" className="flex items-center gap-3 group">
              ...
              <span className="text-lg font-bold tracking-tight text-slate-800 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                Rajat Ranvir
              </span>
            </a>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500/50"
      ...
      <div 
        className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${
          menuOpen ? "max-h-full opacity-100 translate-y-0" : "max-h-0 opacity-0 -translate-y-2"
        }`}
      >
        <div className="px-4 pt-2 pb-6 space-y-2 bg-white/90 dark:bg-[#0a0a0a]/95 backdrop-blur-xl border-t border-slate-100 dark:border-white/5 shadow-xl">
          ...
          <div className="pt-4 mt-4 border-t border-slate-100 dark:border-white/10 animate-in fade-in slide-in-from-bottom-2 duration-500">
